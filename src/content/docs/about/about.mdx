...
<Aside type="danger" title="Retired version">
The OpenAQ version 1 and version 2 endpoints were retired on January 31, 2025
and are no longer be accessible. Please migrate all existing code to version 3
as soon as possible. `/v1` and `/v2` endpoints will return HTTP 410 Gone responses.
</Aside>
