...
The OpenAQ version 1 and version 2 endpoints are deprecated and will be retired
on January 31, 2025 and after which will no longer be accessible. Please migrate
all existing code to version 3 as soon as possible to avoid disruptions. After
January 31, 2025 `/v1` and `/v2` endpoints will return HTTP 410 Gone responses.
</Aside>
