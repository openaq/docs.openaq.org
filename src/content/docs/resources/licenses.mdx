...
title: Licenses
description:
  The Licenses resource provides details about the licenses governing the use of
  data in the OpenAQ API. Learn about permissions and restrictions, such as
  commercial use, attribution, modification, and redistribution, to ensure
...
per OpenAQ’s Terms of Use, compliance is required.
