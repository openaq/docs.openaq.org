...
target="_blank" rel="noopener noreferrer" style="display: inline-flex;">ISO-8601<Icon name="external"/></a> datetime format, e.g.,
...
under the `timezone` key. This follows the tzid in the

<a href="https://www.iana.org/time-zones" target="_blank" rel="noopener noreferrer" style="display:inline-flex;">Time Zone Database<Icon name="external"/></a>
