...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a href="https://explore.openaq.org/register" target="_blank" rel="noopener noreferrer" style="display: inline-flex;">Sign up <Icon name="external" /></a>
      </td>
      <td><a href="mailto:info@openaq.org">Contact us</a></td>
    </tr>
    <tr>
      <td>
        Requirements & Terms:
        <ul>
          <li>Do not leave requests running in perpetuity if data are no longer needed.</li>
          <li>Adherence to OpenAQ Terms of Use is required, including source attribution. We reserve the right to suspend or terminate access should misuse of the OpenAQ Platform occur.</li>
        </ul>
      </td>
      <td>
        Requirements & Terms:
