...
OpenAQ API provides a very generous rate limit for all users that should meet
many needs. If your needs exceed this rate limit we offer custom pricing for the
option for a higher rate limit.
