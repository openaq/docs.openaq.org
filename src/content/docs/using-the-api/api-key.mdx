...
Sign up at <a href="https://explore.openaq.org/register" target="_blank" rel="noopener noreferrer" style="display: inline-flex;"> explore.openaq.org/register <Icon name="external" /></a>to get your API key. You can access and rotate your key from the OpenAQ Explorer
