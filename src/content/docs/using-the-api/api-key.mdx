...
Sign up at the <a href="https://explore.openaq.org/account" target="_blank" rel="noopener noreferrer" style="display: inline-flex;">explore.openaq.org/account<Icon name="external"/></a> to get your API
key. You can access and rotate your key from the OpenAQ Explorer account
settings page <a href="https://explore.openaq.org/account" target="_blank" rel="noopener noreferrer" style="display: inline-flex;">explore.openaq.org/account<Icon name="external"/></a>.
